...
def current_rent_ascending_order():
    ...
    """
    masts_sorted_by_rent = sorted(get_masts_iterable(), key=PhoneMastHelper.rent)[:5]
...
def lease_length_25_years():
    ...
    """
    masts_with_25_year_lease = [mast for mast in get_masts_iterable() if PhoneMastHelper.lease_years(mast)==25]
    print(masts_with_25_year_lease)
    return masts_with_25_year_lease
